...
export const projectsData: Project[] = [
  {
    title: "ZenCost",
    description:
      "Plataforma SaaS de FinOps publicada en AWS Marketplace por Alpha-IB. Permite a equipos de AWS tener visibilidad total, control automatizado y ahorro máximo sobre sus recursos cloud. Integración agentless via IAM Role y CloudFormation StackSets, scheduling automático de recursos, motor de optimización con hallazgos de seguridad y billing, y suite de informes operativos.",
    short_description:
      "Plataforma SaaS de FinOps publicada en AWS Marketplace que unifica visibilidad y control financiero de AWS para equipos cloud.",
    ...
    why_this_project_title:
      "Unificar el control financiero y operativo de la nube en organizaciones enterprise",
  ...
  },
  {
    title: "InformAG",
    description:
      "InformAG es una plataforma agrotecnológica que procesa datos en tiempo real desde sensores para brindar monitoreo y análisis precisos en cultivos y maquinaria agrícola.",
    short_description:
      "Plataforma agrotecnológica para monitorear y analizar datos en tiempo real.",
    ...
    timeline: "2 meses",
    why_this_project_title:
      "Integración y procesamiento de datos agrícolas en tiempo real",
    why_this_project_description:
      "Me uní al proyecto para desarrollar una solución que integrara datos desde sensores agrícolas, transformando información cruda en objetos de dominio para ser procesados, validados y almacenados de forma eficiente para análisis posteriores.",
    solution_title:
      "Procesamiento, validación y exportación de datos con .NET y Azure",
    solution_description:
      "Los datos recibidos se procesan en Azure Functions, donde se mapean con AutoMapper, se realizan cálculos y validaciones, y se exportan en bloques Avro para su almacenamiento en Azure Blob Storage. Se implementaron alertas automáticas ante fallas en la recepción o integridad de los datos.",
    impact_title:
      "Automatización y confiabilidad de procesos de monitoreo agrícola",
    impact_description:
      "La solución permitió monitorear miles de eventos diarios provenientes del campo en tiempo real, con validación automática y alertas ante errores, aumentando la confiabilidad del sistema y reduciendo significativamente la intervención manual.",
    major_challenges_title:
      "Adopción de nuevas tecnologías y alto volumen de datos",
    major_challenges_description:
      "El mayor reto fue aprender C# y .NET 8, junto con los servicios de Azure (Functions, Blob Storage, Azurite) en un entorno con lógica compleja y procesamiento de grandes volúmenes de datos diarios. Requirió una adaptación rápida y comprensión profunda del dominio.",
    technologies_used_description:
      "- Backend: C#, .NET 8, Azure Functions, Apache Avro\n- Infraestructura: Azure Blob Storage, Azurite (local)\n- Testing y resiliencia: xUnit, Polly\n- Herramientas: AutoMapper, Azure DevOps, Azure Pipelines",
  ...
  },
  {
    ...
    autority: Autority.BIGGER,
    hasVideo: false,
    team: "Con 1 CL, 1 desarrollador, 1PM",
    role: "Desarrollador",
    year: "2024",
    timeline: "3 meses",
    why_this_project_title:
...

  {
    ...
    autority: Autority.BIGGER,
    hasVideo: false,
    team: "Con 1 CL, 1 desarrollador, 1PM, 1 diseñador",
    role: "Desarrollador",
    year: "2024",
